...
# MODEL_NAME = "gemini-2.5-pro"  # or "gemini-1.5-pro", "gemini-1.5-base", etc.
...
def main():
    ...
    # Write outputs
    with open('compare_results_summary_gemini.json', 'w', encoding='utf-8') as f:
        json.dump(all_summary, f, indent=2, ensure_ascii=False)

    with open('compare_results_full_gemini.json', 'w', encoding='utf-8') as f:
