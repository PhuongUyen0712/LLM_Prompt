...
# Main execution
def main():
    barem_file = 'self-consitency.txt'
    ...
    # Write outputs
    with open('self_consitency_results_summary.json', 'w', encoding='utf-8') as f:
        json.dump(all_summary, f, indent=2, ensure_ascii=False)

    with open('self_consitency_results_full.json', 'w', encoding='utf-8') as f:
